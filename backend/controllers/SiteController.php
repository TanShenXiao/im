...
//             $this->layout = "lte_main";
            ...
            $sysInfo = [
                ...
                ['name'=> '主机名', 'value'=>php_uname('n')],  //'value'=>php_uname('s').' '.php_uname('r').' '.php_uname('v')],
                ['name'=> '机器类型', 'value'=>php_uname('m')],  //'value'=>php_uname('s').' '.php_uname('r').' '.php_uname('v')],
    ...
    public function actionLogin()
    {
        ...
        if(AdminUser::login($username, $password, $rememberMe) == true){
            AdminUser::updateAll(
                ['last_ip' => CommonFun::getClientIp(),'password_reset_token' => Yii::$app->security->generateRandomString() . '_' . time()],
                ['uname' => $username]
                );
            //return $this->goBack();
    ...
    public function actionLogout()
    {
        ...
        Yii::$app->user->identity->removePasswordResetToken();
